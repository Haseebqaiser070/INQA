...
export default function Settings() {
  ...
  return (
    <div>
      ...
      <Confirm
        title="Are you sure you want to regenerate the login code?"
      ...
      <Container>
          ...
          <Stack direction="row" alignItems="center" alignItems="center" justifyContent="space-between" mb={5}>
            ...
            <div>
              <div>
                ...
                <Link to="/dashboard/add_company_user">
        ...
        >
          <Link to="/dashboard/comapny_user_settings" className="text-decoration-none text-muted">
            <MenuItem>
