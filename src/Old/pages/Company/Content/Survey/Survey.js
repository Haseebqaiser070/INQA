...
export default function Survey() {
  ...
  return (
    <>
      ...
      <Box sx={{ width: '100%', typography: 'body1' }}>
        <TabContext value={value}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }} className="d-flex align-items-center">
            ...
            <Link to={'/dashboard/add_survey'} className=" ms-auto">
              <Button variant="contained" startIcon={<Iconify icon="mingcute:add-fill" />}>
                New Survey
              </Button>
            </Link>
            </div>
                  ...
                  {[1, 2, 3].map((id) => {
                    return (
                      ...
                      <Checkbox checked={selectedUser} onChange={(event) => handleClick(event, name)} />
                        ...
                        <TableCell align="left">15 participants</TableCell>

                        <TableCell align="right">Posted By Admin</TableCell>
                        <TableCell align="right">12,10,2023</TableCell>
      ...
      >
        <MenuItem className='popover-item' onClick={() => navigate('/dashboard/view_survey/1')}>
          <Iconify icon={'carbon:result'} sx={{ mr: 2 }} />
          Result
        </MenuItem>
        <MenuItem className='popover-item' onClick={() => navigate('/dashboard/submit_survey')}>
          <Iconify icon={'material-symbols:add'} sx={{ mr: 2 }} />
          Fill survey
        </MenuItem>
        <MenuItem className='popover-item' onClick={() => navigate('/dashboard/add_survey/1')}>
