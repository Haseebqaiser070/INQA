...
export default function Messages() {
  ...
  return (
    <>
      ...
      <Box sx={{ width: '100%', typography: 'body1' }}>
        <TabContext value={value}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }} className="d-flex align-items-center">
            ...
            <Link to={'/dashboard/add_message'} className=" ms-auto">
      ...
      >
        <MenuItem className='popover-item' onClick={() => navigate('/dashboard/view_message/1')}>
          <Iconify icon={'carbon:view'} sx={{ mr: 2 }} />
          View
        </MenuItem>
        <MenuItem className='popover-item' onClick={() => navigate('/dashboard/add_message/1')}>
