      ...
      <Container>
        ...
        <div className="row d-flex mt-4 flex-wrap justify-items-between">
          ...
          <div className="col-md-7 d-flex align-items-ceenter justify-content-md-end">
            ...
            <Link to="/dashboard/add_company_user/1">
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            User details
            <Link smooth to="/dashboard/add_company_user/1">
              <Iconify
          ...
          <Typography className="text-muted">Full Name ,Surename</Typography>
        </div>
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Password
            <Link smooth to="/dashboard/add_company_user/1#password">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            User Role
            <Link smooth to="/dashboard/add_company_user/1#role">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Language
            <Link smooth to="/dashboard/add_company_user/1#languages">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
