      ...
      <Container>
        ...
        <div className="row d-flex mt-4 flex-wrap justify-items-between">
          ...
          <div className="col-md-7 d-flex align-items-ceenter justify-content-md-end">
            ...
            <Link smooth to="/dashboard/adduser/3">
        ...
        <UserAvatar
          currentImg={
            '/assets/images/avatars/logo.png'
          }
        />
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Company colours
            <Link smooth to="/dashboard/adduser/1#colours">
              <Iconify
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Contact person
            <Link smooth to="/dashboard/adduser/1">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Company details
            <Link smooth to="/dashboard/adduser/1#companydetails">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            ...
            <Link to="/dashboard/adduser/1#languages">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row d-flex mt-4 flex-wrap justify-items-between">
          ...
          <div className="col-sm-5 text-end">
            <Link to="/dashboard/adduser/1#billing">
              <Button variant="contained" className="mx-2">
                Edit
              </Button>
            </Link>
        ...
        <div className="row mb-5 mt-4">
          <Typography variant="h5" className="text-muted mb-3">
            Billing plan
            <Link to="/dashboard/adduser/1#billingplan">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row mb-5 mt-4">
          <Typography variant="h5" className="text-muted mb-3">
            Inovices
            <Link to="/dashboard/adduser/1#inovices">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
