    ...
    <div style={{ overflow: 'hidden', minHeight: '90vh', position: 'relative' }} className="p-0 m-0">
      ...
      <div className="gradiant-container container-fluid">
        <Container className="p-0 ">
          <div className="d-flex ms-0 flex-wrap p-4 ps-2 mt-5 col-xl-7  col-md-9 col-12">
      ...
      <div style={{ width: '1100px', height: '1100px', backgroundColor: '#EFF4FF',position:'absolute',right:'-500px',bottom:'-560px',borderRadius:'50%'}}>
