...
export default function Inovices() {
  ...
  const deleteData = () => {
    toast.success('Inovice Deleted Successfully');
                  ...
                  {[1, 2, 3].map((id) => {
                    return (
                      ...
                      <Checkbox checked={selectedUser} onChange={(event) => handleClick(event, name)} />
                        ...
                        <TableCell align="right">Company / Account name</TableCell>
                        <TableCell align="right">xx.xx €</TableCell>
                        <TableCell align="right">
                          <span className={(id % 2 === 0 && 'text-danger') || 'text-success'}>
                            {id==1?  <span className='text-muted'>
                                Sent
                        ...
                        (    id % 2 === 0 ? (
                              ...
                              <>
                                Paid
                                <Iconify className="ms-2" icon="teenyicons:tick-circle-outline" />
                              </>
                            ))}
                          </span>
                        </TableCell>
