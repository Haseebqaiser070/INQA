  ...
  return (
    <div>
      ...
      <Container>
        ...
        <UserAvatar currentImg={'https://media.sproutsocial.com/uploads/2022/06/profile-picture.jpeg'} />

        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Supervisor account
            <Link smooth to="/dashboard/edit-account">
              <Iconify
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Password
            <Link smooth to="/dashboard/edit-account#password">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row my-5">
          <Typography variant="h5" className="text-muted my-3">
            Company details
            <Link smooth to="/dashboard/edit-account#companydetails">
              <Iconify
                className="ms-4 my-auto text-primary"
                width="30px"
                role="button"
        ...
        <div className="row d-flex mt-4 flex-wrap justify-items-between">
          ...
          <div className="col-sm-2">
            <Link smooth to="/dashboard/edit-account#billing">
              <Button variant="contained" className="">
                Edit
              </Button>
            </Link>
