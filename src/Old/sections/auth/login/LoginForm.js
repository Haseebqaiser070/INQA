...
// @mui
import { Link, Stack, Button, Box, Modal, IconButton, InputAdornment, Alert, TextField, Checkbox } from '@mui/material';
...
export default function LoginForm() {
  ...
  return (
    <>
      <Modal open={showForgotPasswordModal} onClose={closeForgotPasswordModal} aria-labelledby="forgot-password-modal">
        <Box
          sx={{
            position: 'absolute',
            top: '50%',
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ my: 2 }}>
        ...
        <Link role="button" variant="subtitle2" underline="hover" onClick={openForgotPasswordModal}>
          Problems logging in?
        </Link>
      </Stack>
